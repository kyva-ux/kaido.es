import { getCurrentInstance, version, defineComponent, computed, ref, h, resolveComponent, reactive, useSSRContext, createApp, toRef, isRef, defineAsyncComponent, provide, onErrorCaptured, unref, inject } from 'vue';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}>Welcome to kaido.es!</div>`);
}
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.f36d58da.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, __nuxt_component_0 as a, entry$1 as default, useNuxtApp as u };
